...
import com.territorial.auction.domain.season.repository.UserMissionProgressRepository;
...
public class MissionService {
    ...
    public MissionListResponse getMissions(Long userId) {
        ...
        Map<Long, UserMissionProgress> progressMap =
                userMissionProgressRepository
                        .findByUser_IdAndMission_Season_Id(userId, season.getId())
                        .stream()
                        .collect(
    ...
    private UserMissionProgress findOrCreateProgress(
        ...
        return userMissionProgressRepository
                .findByUser_IdAndMission_Id(userId, mission.getId())
                .orElseGet(
                        () -> {
                            User user =
                                    userRepository

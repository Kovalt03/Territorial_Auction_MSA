...
class GlobalVaultServiceTest {
    ...
    class GetVault {
        ...
        void vaultMissing_createsDefault() {
            GlobalVault created = GlobalVault.builder().userId(1L).build();
        ...
        void vaultAndUserMissing() {
            ...
            given(userSnapshotRepository.existsById(99L)).willReturn(false);
    ...
    class TransferToVault {
        ...
        void toVault_success() {
            given(territoryContextPort.findById(42L)).willReturn(Optional.of(territory));
            given(globalVaultRepository.findByIdWithLock(1L)).willReturn(Optional.of(vault));
    ...
    class TransferValidation {
        ...
        void territoryNotFound() {
            given(territoryContextPort.findById(999L)).willReturn(Optional.empty());
        ...
        void notTerritoryOwner() {
            territory = new TerritoryContext(42L, 2L, 10, 2, 4);

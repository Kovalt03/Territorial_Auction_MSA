...
import com.territorial.admin.domain.admin.dto.AdminLevelSpecsRequest;
...
import com.territorial.admin.domain.admin.service.AdminBuildingService;
...
public class AdminBuildingController {
    ...
    public ResponseEntity<ApiResponse<java.util.Map<Integer, Integer>>> updateCastleLimits(
            @AuthenticationPrincipal Long adminUserId,
            @PathVariable Long buildingTypeId,
            @RequestBody com.territorial.admin.domain.admin.dto.AdminCastleLimitsRequest request) {
        return ResponseEntity.ok(
                ApiResponse.ok(

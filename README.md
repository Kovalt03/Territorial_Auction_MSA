...
- auction-service와 user-service는 각각 독립 PostgreSQL을 소유합니다. combat-service는 전용 DB·보안·Flyway 위에 building, unit/research, siege core와 transactional outbox를 이관했으며, 공개 요청은 계약 연결과 cutover 전까지 모놀리식이 처리합니다.
...
| 3 | combat-service | 공성 core까지 이관·서비스 계약 연결 예정 | [추출 설계](docs/design/msa/combat-extraction.md) · [이관 기록](docs/design/msa/combat-migration-tracking.md) |

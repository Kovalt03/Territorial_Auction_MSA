...
- auction-service와 user-service는 각각 독립 PostgreSQL을 소유합니다. combat-service는 전용 DB·보안·Flyway scaffold를 확보했고, 공개 요청은 core 이관과 cutover 전까지 모놀리식이 처리합니다.
...
| 3 | combat-service | scaffold 완료·core 이관 대기 | [추출 설계](docs/design/msa/combat-extraction.md) · [이관 기록](docs/design/msa/combat-migration-tracking.md) |
